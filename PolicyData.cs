...
namespace PolicyMicroservice
{
    public class PolicyData
    {
        public static List<Policy> policyList = new List<Policy>
        {
            ...
            new Policy{PolicyId=3,PolicyNo=103,Premium=20000.00,Tenure=5,BenefitId=2}
        ...
        { 
           ...
           new MemberPolicy{MemberId=4,PolicyId=3,PolicyNo=103,BenefitId=2,Tenure=5,SubscriptionDate=new DateTime(2021, 06, 10),CapAmountBenefits=90000.00}
        };
        ...
        public static List<ProviderPolicy> providerpolicyList = new List<ProviderPolicy>
        {
            ...
            new ProviderPolicy{HospitalId=4,HospitalName="Chettinad Hospital",HospitalAddress=" Lake",Location="Chennai",PolicyId=3}
        };
